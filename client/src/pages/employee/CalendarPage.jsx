...
const eventColors = { meeting: '#8B5CF6', deadline: '#F43F5E', task: '#10B981' };
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary text-sm mt-1">Your meetings and task due dates</p>
        </div>
        <Button size="sm" onClick={() => showToast.info('Meetings are scheduled by HR — check Meetings tab')}>Info</Button>
      </div>
